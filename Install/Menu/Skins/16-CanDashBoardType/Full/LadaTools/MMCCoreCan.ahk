...
Gui, 17:Add, Picture, vBATCHARGE  gDashBoardRun x150 y0 w40 h40, %A_ScriptDir%\skin\can\can_bat.bmp
Gui, 17:Add, Picture, gDashBoardRun x210 y0 w40 h40, %A_ScriptDir%\skin\can\can_gas_n.bmp
Gui, 17:Add, Picture, gDashBoardRun x345 y0 w40 h40, %A_ScriptDir%\skin\can\can_airtemp.bmp
Gui, 17:Add, Picture, gDashBoardRun x480 y0 w40 h40, %A_ScriptDir%\skin\can\can_gearboxtemp_n.bmp
Gui, 17:Add, Picture, vEngineTemp gDashBoardRun x615 y0 w40 h40, %A_ScriptDir%\skin\can\can_enginetemp_n.bmp

Gui, 17:Add, Text, vFuel gDashBoardRun 0x1 x250 y5 w95 h30, 0.0 л.
Gui, 17:Add, Text, vAirTemp gDashBoardRun 0x1 x385 y5 w95 h30, 0 °C
Gui, 17:Add, Text, vGearboxTemp gDashBoardRun 0x1 x520 y5 w95 h30, 0 °C
Gui, 17:Add, Text, vTempEngine gDashBoardRun 0x1 x655 y5 w95 h30, 0 °C
...
GearboxTemp:
		if (DashBoardRuning=1)
			...
			if(CanGearboxTemp<>CanGearboxTempOld)
			{

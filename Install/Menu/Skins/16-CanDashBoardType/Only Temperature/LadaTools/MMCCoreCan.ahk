...
if(CanAutoHideAllow=1 and DashBoardAutoStart=1 and CanEngineTemp>50 and CanEngineTemp<110)
{
DashBoardAutoStart=0
gosub DashBoardRun
}
...
Gui, 17:Add, Picture, vEngineTemp gDashBoardRun x0 y0 w40 h40, %A_ScriptDir%\skin\can\can_enginetemp_n.bmp
Gui, 17:Add, Text, vTempEngine gDashBoardRun 0x1 x40 y5 w80 h30
Gui, 17:Show, x620 y440 w120 h40, CanEngine
